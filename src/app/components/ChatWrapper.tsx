...
import { Chat, OverlayProvider, OverlayContextValue, useCreateChatClient } from "stream-chat-expo";
...
const streamTheme = getStreamTheme(isDark);

return (
  <OverlayProvider key={isDark ? "dark" : "light"} value={streamTheme as Partial<OverlayContextValue>}>
