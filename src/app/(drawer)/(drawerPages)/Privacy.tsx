  ...
  return (
    <>
      ...
      >
        ...
        <Text
          style={[styles.updated, { color: theme.subtext }]}
          className="text-center"
        >
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.paragraph, { color: theme.subtext }]}>
            ...
            collect technical information like device type, operating system,
            and usage data.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.paragraph, { color: theme.subtext }]}>
            We use this data to improve your experience, provide relevant
            content, ensure platform security, and support civic engagement.
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.paragraph, { color: theme.subtext }]}>
            ...
            data at any time. You may also request to opt out of certain data
